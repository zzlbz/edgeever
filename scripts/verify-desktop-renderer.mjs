...
try {
  ...
  await verifyEntry({
    ...
    readySelector: '[data-desktop-renderer-test-ready][data-diagram-editor-regression-ready="true"][data-bundled-marketplace-regression-ready="true"] [data-bubble-menu-regression-ready="true"]',
